# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.0a1 on Sun Jul 11 00:30:37 2021
#
...
class ConfigurationDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        sizer_dialog.Add(sizer_timings, 4, wx.ALL | wx.EXPAND, 5)
        ...
        label_text_ctrl_add_time_intervals = wx.StaticText(self, wx.ID_ANY, self._("Time Extension Intervals"))
        grid_sizer_timings.Add(label_text_ctrl_add_time_intervals, 0, wx.ALL, 5)

        self._text_ctrl_add_time_intervals = wx.TextCtrl(self, wx.ID_ANY, "")
        ...
        sizer_dialog.Add(sizer_background_colors, 5, wx.ALL | wx.EXPAND, 5)
